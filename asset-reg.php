...
if (isset($_POST['submit'])) {
  ...
  if ($userID == '' || $regNumber == ""  || $itemDescription == "" || $itemModel == "" || $serialNumber == "") {
    ...
    $image_filename = uniqid() . '.' . $image_type;
    $fileName = $folderPath . $image_filename;
    file_put_contents($fileName, $image_base64);
  }
  if (($validate->registerAsset($userID, $regNumber, $itemDescription, $itemModel, $serialNumber, $image_filename)) == 'Mail Send') {

    echo '<script>alert("Email Send")</script>';
  } else if (($validate->registerAsset($userID, $regNumber, $itemDescription, $itemModel, $serialNumber, $image_filename)) == 'Missing') {
    echo '<script>alert("This asset is Missing")</script>';
  } else if (($validate->registerAsset($userID, $regNumber, $itemDescription, $itemModel, $serialNumber, $image_filename)) == 'Error saving asset') {
...
<head>
  ...
  <title>HIT ACMS - Asset Registration</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Asset Registration</h1>

          <form class="user" action="#" method="post">
            <div class="form-group row">
              <div class="col-sm-6 mb-3 mb-sm-0">
                <input type="text" class="form-control form-control-user" id="regNumber" name="regNumber" placeholder="Student Registration Number" required>
                <span id="regex"></span>
              </div>
              <div class="col-sm-6">
                <input type="text" class="form-control form-control-user" id="itemDescription" name="itemDescription" placeholder="Item Description" required>
              </div>
            </div>
            <div class="form-group row">
              <div class="col-sm-6">
                <input type="text" class="form-control form-control-user" id="itemModel" name="itemModel" placeholder="Device Model" required>
              </div>
              <div class="col-sm-6">
                <input type="text" class="form-control form-control-user" id="serialNumber" name="serialNumber" placeholder="Serial Number" required>
              </div>
            </div>
