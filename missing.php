...
if (isset($_POST['send'])) {
  $image = $_POST['link'];
  $name = $_POST['name'];
  $regnumber = strtolower($_POST['regnumber']);
  $email = $regnumber . '@hit.ac.zw';
  $link = 'http://templates.merza.co.zw/verify.php?qrcode=' . $image;
  $message = $validate->message($name, $link);
  if (($validate->sendEmail($email, $message)) == 'mail send') {
...
<head>
  ...
  <title>HIT ACMS - Search Asset</title>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="blacklist.php">Asset Blacklist</a>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <h1 class="h3 mb-4 text-gray-800">Search Asset</h1>

          <form class="user" action="#" method="post">
            <div class="form-group row">
              <div class="col-sm-6 mb-3 mb-sm-0">
                <input type="text" class="form-control form-control-user" id="regNumber" name="regNumber" value="" placeholder="Student Registration Number">
                <span id="regex"></span>
              </div>
              <div class="col-sm-6">
                <input type="text" class="form-control form-control-user" id="assetID" name="assetID" value="" placeholder="Asset ID">
              </div>
            </div>
            ...
            <div class="col-6">
              <div class="card">
                <div class="card-body">
                  <input type="submit" value="Search" id="submit" class="btn btn-danger" name="submit">
                </div>
              </div>
            </div>
          </form>
        ...
        <div class="container d-none" id="success">
          ...
          if (assetID == '' || regNumber == '') {
            ...
            $.ajax({
              ...
              success: function(data) {
                ...
                <td>${dataArray[3]}</td>
                <td>${dataArray[2]}</td>
                <td>${dataArray[4]}</td>                <td>${dataArray[5]}</td>
                <td>
                <form action="#" method="post">                
                <input type="submit" value="Send Email" class="btn btn-danger" name="send">
                <input type="hidden" name="regnumber" value="${dataArray[4]}">
                <input type="hidden" name="link" value="${dataArray[6]}">
                <input type="hidden" name="name" value="${dataArray[7]}">
                </form>
</td>
                ">
